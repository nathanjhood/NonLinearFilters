...
/**
*/
class FirstOrderNonLinearFilterAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    FirstOrderNonLinearFilterAudioProcessorEditor (FirstOrderNonLinearFilterAudioProcessor&);
